...
class Migration018ProjectMembersTable extends BaseMigration {
  ...
  Future<void> up() async {
    try {
      ...
      await addColumnComment('project_members', 'status', '状态：pending/active/inactive');
