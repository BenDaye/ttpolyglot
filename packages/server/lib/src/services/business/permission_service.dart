...
class PermissionService extends BaseService {
  ...
  Future<bool> checkUserPermission({
    ...
    try {
      logInfo('检查用户权限: $userId, $permission, 项目: $projectId');
      ...
      logError('权限检查失败', error: error, stackTrace: stackTrace);
      return false;
    }
  }
  ...
  Future<Map<String, bool>> checkUserPermissionsBatch({
    ...
    try {
      logInfo('批量检查用户权限: $userId, 权限数量: ${permissions.length}, 项目: $projectId');
      ...
      logError('批量权限检查失败', error: error, stackTrace: stackTrace);
      // 返回默认的false结果
  ...
  Future<bool> isSuperAdmin(String userId) async {
    try {
      ...
      logError('超级管理员检查失败', error: error, stackTrace: stackTrace);
      return false;
    }
  }
  ...
  Future<bool> isProjectOwner({
    ...
    try {
      ...
      logError('项目所有者检查失败', error: error, stackTrace: stackTrace);
      return false;
    }
  }
  ...
  Future<List<String>> getUserProjectRoles(String userId, String projectId) async {
    try {
      ...
      logError('获取用户项目角色失败', error: error, stackTrace: stackTrace);
      return [];
    }
  }
  ...
  Future<List<String>> getUserGlobalRoles(String userId) async {
    try {
      ...
      logError('获取用户全局角色失败', error: error, stackTrace: stackTrace);
      return [];
    }
  }
  ...
  Future<List<String>> getUserPermissions(String userId, {String? projectId}) async {
    try {
      ...
      logError('获取用户权限失败', error: error, stackTrace: stackTrace);
      return [];
    }
  }
  ...
  Future<void> warmupUserPermissionCache(String userId, {String? projectId}) async {
    try {
      logInfo('预热用户权限缓存: $userId, 项目: $projectId');
      ...
      logInfo('用户权限缓存预热完成: $userId');
    } catch (error, stackTrace) {
      logError('预热用户权限缓存失败: $userId', error: error, stackTrace: stackTrace);
    }
  }
  ...
  Future<void> clearUserPermissionCache(String userId, {String? projectId}) async {
    try {
      ...
      logInfo('用户权限缓存已清除: $userId');
    } catch (error, stackTrace) {
      logError('清除用户权限缓存失败', error: error, stackTrace: stackTrace);
    }
  }
  ...
  Future<void> clearRolePermissionCache(String roleName) async {
    try {
      ...
      logInfo('角色权限缓存已清除: $roleName');
    } catch (error, stackTrace) {
      logError('清除角色权限缓存失败', error: error, stackTrace: stackTrace);
    }
  }
  ...
  Future<Map<String, dynamic>> getPermissionStats() async {
    try {
      ...
      logError('获取权限统计信息失败', error: error, stackTrace: stackTrace);
      return {};
    }
  }
}
