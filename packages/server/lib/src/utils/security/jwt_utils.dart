...
class JwtUtils {
  ...
  String generateAccessToken(Map<String, dynamic> payload) {
    try {
      ...
      ServerLogger.error('生成访问令牌失败', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  String generateRefreshToken(Map<String, dynamic> payload) {
    try {
      ...
      ServerLogger.error('生成刷新令牌失败', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Map<String, dynamic>? verifyToken(String token) {
    try {
      ...
      if (!payload.containsKey('user_id') || !payload.containsKey('exp')) {
        ServerLogger.warning('JWT令牌缺少必要字段');
        return null;
      }
      ...
      ServerLogger.warning('JWT验证失败', error: error);
      return null;
    } catch (error, stackTrace) {
      ServerLogger.error('JWT验证出错', error: error, stackTrace: stackTrace);
      return null;
    }
  }
  ...
  String generatePasswordResetToken(String userId, String email) {
    try {
      ...
      ServerLogger.error('生成密码重置令牌失败', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Map<String, dynamic>? verifyPasswordResetToken(String token) {
    try {
      ...
      if (payload['purpose'] != 'password_reset') {
        ServerLogger.warning('无效的密码重置令牌用途');
        return null;
      }

      return payload;
    } catch (error, stackTrace) {
      ServerLogger.error('验证密码重置令牌失败', error: error, stackTrace: stackTrace);
      return null;
    }
  }
  ...
  String generateEmailVerificationToken(String userId, String email) {
    try {
      ...
      ServerLogger.error('生成邮箱验证令牌失败', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Map<String, dynamic>? verifyEmailVerificationToken(String token) {
    try {
      ...
      if (payload['purpose'] != 'email_verification') {
        ServerLogger.warning('无效的邮箱验证令牌用途');
        return null;
      }

      return payload;
    } catch (error, stackTrace) {
      ServerLogger.error('验证邮箱验证令牌失败', error: error, stackTrace: stackTrace);
      return null;
    }
  }
